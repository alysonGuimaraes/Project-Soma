...
import 'package:project_soma/features/transaction/data/model/transaction_model.dart';
...
void main() {
  group('TransactionModel |', () {
    ...
    test('Should convert the model to a SQLite-compatible Map (toMap)', () {
      ...
      expect(result['monthYear'], '032026');
      expect(
        result['isFixed'],
        1,
    ...
    test('Should omit id from toMap when null (new transaction)', () {
